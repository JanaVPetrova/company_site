...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { description: @price.description, price: @price.price, service_name: @price.service_name, time: @price.time }
    end
  ...
  test "should update price" do
    put :update, id: @price, price: { description: @price.description, price: @price.price, service_name: @price.service_name, time: @price.time }
    assert_redirected_to price_path(assigns(:price))
  end
